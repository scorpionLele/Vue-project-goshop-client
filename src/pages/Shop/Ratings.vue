<template>
  <div class="ratings">
    <div class="ratings-content">
      ...
      <div>
        <RatingsFilter :active="isShow" :isHaveText="isHaveText" :toggleActive="toggleActive" :haveRatingText="haveRatingText"></RatingsFilter>
      </div>

      <div class="rating-wrapper">
        <ul ref="ratingList">
          <li class="rating-item" v-for="(rating,index) in showRatings" :key="index">
            <div class="avatar">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    computed:{
      ...
      showRatings (){
        ...
        if(this.isShow === 0){
          ...
          ratingArr = this.ratings.filter((rating)=>rating.score >= 3)
        }else{
          ratingArr = this.ratings.filter((rating)=>rating.score < 3)
        }
        if(this.isHaveText){
          ratingArr = ratingArr.filter(rating=>rating.text.trim())
        }
        return ratingArr
      }
    },
    methods:{
      ...
      haveRatingText (isHaveText){
        this.isHaveText = !this.isHaveText
      },
      initScroll (){
        new BScroll('.ratings',{
