  ...
  <div class="shop-header">
    ...
    <div class="activity-sheet" v-show="isShowSupport">
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item" v-for="(support,index) in info.supports" :class="supportTypes[support.type]" :key="index">
            <span class="content-tag">
      ...
      <div class="activity-sheet-cover" v-if="isShowSupport" @click="isShowSupport = false"></div>
    </div>
  </div>
</template>
  ...
  export default {
    data (){
      return {
        ...
        supportTypes:['activity-green','activity-red','activity-orange']
      }
    },
